...
var data_basic = {
    'snippets': [
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full padding-50" style="text-align: center;">' +
						...
						'<div class="spacer height-40"></div><span><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Contact Me</a></span>' +
					'</div>' +
				'</div>'
		},
		...
		*/
	...
	
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Contact Us</a>' +
					'</div>' +
				'</div>'
		},
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Shop Now</a>' +
					'</div>' +
				'</div>'
		},
       
        {
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Our Products</a>' +
					'</div>' +
				'</div>'
		},
				
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full right">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 size-16 text-black tracking-75 font-normal uppercase px-11 border-current hover:border-current rounded-full py-3">Browse Menu</a>' +
					'</div>' +
				'</div>'
		},
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Get A Quote</a>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div style="margin: 10px 0">' +
							_tabs(1) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 size-16 text-black tracking-75 font-normal uppercase px-11 border-current hover:border-current rounded-full py-3">All Products</a>' +
				        '\n</div>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':				
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Contact Us</a>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded tracking-75 uppercase py-2 size-14 px-8 border-current text-black hover:border-current font-normal">Book a Consultation</a>' +
					'</div>' +
				'</div>'
		},
   
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">New Arrivals</a>' +
					'</div>' +
				'</div>'
		},
     
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full right">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Our Works</a>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full right">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 size-16 text-black tracking-75 font-normal uppercase px-11 border-current hover:border-current rounded-full py-3">Our Menu</a>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">View Portfolio</a>' +
					'</div>' +
				'</div>'
		},
    
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">View Collection</a>' +
					'</div>' +
				'</div>'
		},
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">View Gallery</a>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<div class="center" style="margin: 15px 0">' +
							'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">View Destinations</a>' +
						'</div>' +
					'</div>' +
				'</div>'
		},
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid mr-1 tracking-75 uppercase py-2 size-14 px-8 border-current rounded text-black hover:border-current font-normal ml-0">Contact Us</a></div>' +
					'</div>' +
				'</div>'
		},
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid mr-1 tracking-75 uppercase py-2 size-14 px-8 border-current rounded text-black hover:border-current font-normal ml-0">Get a Quote</a></div>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						...
						'\n<div style="margin:1.2em 0">' +
							_tabs(1) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Buy Now</a>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						...
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;">' +
								...
								_tabs(2) + '<div style="margin:20px 0">' +
									_tabs(3) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Buy Now</a>' +
								_tabs(2) + '</div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div style="padding-right: 40px">' +
							...
							_tabs(1) + '<div class="spacer height-20"></div>' +
							_tabs(1) + '<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Buy Now</a></div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
				...
				`<div class="row clearfix">
					...
					<div class="column half">
						<div style="padding-left: 10px;">
							...
							<div class="spacer height-20"></div>
							<p style="text-align: justify;">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
							<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 text-black tracking-75 font-normal uppercase px-6 py-2 size-12" title="">Add to Cart</a> &nbsp; <a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase px-6 py-2 size-12 border-current hover:border-current" title="">Buy Now</a></div>
							<div class="spacer height-20"></div>
					...
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:30px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<p>Lorem Ipsum is dummy text of the printing industry.</p>' +
								_tabs(2) + '<div style="margin:1.2em 0">' +
									_tabs(3) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Select Plan</a>' +
								_tabs(2) + '</div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						...
						'\n<div style="margin:1.5em 0">' +
							_tabs(1) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Get Started</a>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
					...
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<p>Lorem Ipsum is dummy text of the printing industry.</p>' +
								_tabs(2) + '<div style="margin:1.2em 0">' +
									_tabs(3) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Purchase</a>' +
								_tabs(2) + '</div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						...
						'\n<div style="margin:1.2em 0">' +
							_tabs(1) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Select Plan</a>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						...
						'\n<div style="margin:2em 0 1em">' +
							_tabs(1) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Buy Now</a>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						...
						'\n<div style="margin:2em 0">' +
							_tabs(1) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Choose Plan</a>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<h3>PREMIUM</h3>' +
						...
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<div style="margin:1.5em 0">' +
									_tabs(3) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Choose Plan</a>' +
								_tabs(2) + '</div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					...
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Get Started</a></div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Back to Home</a>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Homepage</a>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Back to Home</a>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div style="margin: 25px 0">' +
							_tabs(1) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Back to Home</a>' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						...
						'\n<div style="margin: 35px 0">' +
							...
							_tabs(1) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Homepage</a>' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						...
						'\n<div style="margin: 3em 0">' +
							_tabs(1) + '<a href="#" class="is-btn is-btn-ghost2 is-upper is-btn-small">Contact Us</a> &nbsp;' +
							_tabs(1) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Notify Me</a>' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Notify Me</a>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<div class="center"><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Notify Me</a></div>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<div class="center">' +
							_tabs(1) + '<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Drop us a line</a>' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 size-16 tracking-75 uppercase py-3 px-11 font-semibold text-gray-600">Read More</a><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded size-16 tracking-75 uppercase py-3 px-11 border-current text-indigo-500 hover:bg-indigo-500 hover:text-white hover:border-transparent font-semibold">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 size-16 tracking-75 uppercase py-3 px-11 font-semibold text-gray-600">Read More</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded size-16 tracking-75 uppercase py-3 px-11 border-current text-indigo-500 hover:bg-indigo-500 hover:text-white hover:border-transparent font-semibold">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 tracking-75 uppercase py-2 size-14 px-8 font-semibold text-gray-600">Read More</a><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded tracking-75 uppercase py-2 size-14 px-8 border-current hover:text-white hover:border-transparent font-semibold text-indigo-500 hover:bg-indigo-500">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 tracking-75 uppercase py-2 size-14 px-8 font-semibold text-gray-600">Read More</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded tracking-75 uppercase py-2 size-14 px-8 border-current hover:text-white hover:border-transparent font-semibold text-indigo-500 hover:bg-indigo-500">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent bg-gray-200 hover:bg-gray-300 size-16 tracking-75 uppercase py-3 px-11 font-semibold text-gray-600 rounded-full">Read More</a><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 size-16 tracking-75 uppercase py-3 px-11 border-current text-indigo-500 hover:bg-indigo-500 hover:text-white hover:border-transparent font-semibold rounded-full">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent bg-gray-200 hover:bg-gray-300 size-16 tracking-75 uppercase py-3 px-11 font-semibold text-gray-600 rounded-full">Read More</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 size-16 tracking-75 uppercase py-3 px-11 border-current text-indigo-500 hover:bg-indigo-500 hover:text-white hover:border-transparent font-semibold rounded-full">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent bg-gray-200 hover:bg-gray-300 tracking-75 uppercase py-2 size-14 px-8 font-semibold text-gray-600 rounded-full">Read More</a><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 uppercase py-2 size-14 px-8 border-current hover:text-white hover:border-transparent font-semibold text-indigo-500 hover:bg-indigo-500 tracking-75 rounded-full">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent bg-gray-200 hover:bg-gray-300 tracking-75 uppercase py-2 size-14 px-8 font-semibold text-gray-600 rounded-full">Read More</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 uppercase py-2 size-14 px-8 border-current hover:text-white hover:border-transparent font-semibold text-indigo-500 hover:bg-indigo-500 tracking-75 rounded-full">Buy Now</a></div>`
		},
        ...
        */
		...
		// CONTACT FORM
		// Enable this module after setting-up your end-point for receiving the submitted form
		/*
        {
